...
def jsonify(*args, **kwargs):
    ...
    """
    return Response(json.dumps(dict(*args, **kwargs), cls=MongoJsonEncoder, ensure_ascii=False), mimetype='application/json', content_type='application/json; charset=utf-8')
