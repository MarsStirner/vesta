...
class DictionaryNamesAPITestCase(unittest.TestCase):
    ...
    def test_put_dictionary(self):
        ...
        response = self.app.put('/'.join((self.api_url, code)), data_update)
        self.assertEqual(response.status_code, 200)
        response = self.get_by_code(code)
        self.assertEqual(response.status_code, 200)
        response_data = response.get_data()
...
class DictionaryAPITestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        app.config['MONGODB_DB'] = TEST_DB
        self.app = app.test_client()
        self.api_url = '/dictionary'
        self.collection_code = 'test_dictionary'
    ...
    def test_post_list(self):
        ...
        response = self.app.post('/'.join((self.api_url, self.collection_code)), data)
        self.assertEqual(response.status_code, 201)
    ...
    def test_put_doc(self):
        ...
        response = self.app.put('/'.join((self.api_url, self.collection_code, document_id)), update_data)
